...
const Navbar = () => {
  return (
    ...
    <div className="flex items-center justify-center lg:w-[1189px] lg:h-[68px] md:w-[747px] md:h-[50px] mt-[28px] sm:w-[351px] sm:h-[33px] ">
      <img src={iconMenu} alt="Hamburger Menu" className="w-[23px] h-[21px] lg:hidden md:hidden block relative top-[3px] mr-[16px]" />
      <h1
        className={`${styles.heading2} mr-[50px] md:mr-[35px] sm:mr-[73px]sm:h-[40px]`}>
        sneakers
      </h1>
      <nav
        className={`${styles.flexCenter} list-none  mr-[350px] md:mr-[90px] sm:hidden md:flex lg:flex flex-row items-center`}>
        {nav.map((navBar, index) => (
          <li
            key={navBar.id}
            className={`${styles.navbarText}
